...
export const AuroraBackground = ({ className }: Props) => {
  return (
    ...
    >
      ...
      <div className="absolute -top-40 left-1/4 h-[42rem] w-[42rem] -translate-x-1/2 rounded-full bg-primary/25 blur-[120px] animate-aurora" />
      <div
        className="absolute top-10 right-0 h-[34rem] w-[34rem] rounded-full bg-[oklch(0.7_0.16_300)]/20 blur-[120px] animate-aurora"
        style={{ animationDelay: '-6s', animationDuration: '22s' }}
      />
      <div
        className="absolute bottom-0 left-10 h-[30rem] w-[30rem] rounded-full bg-[oklch(0.72_0.15_60)]/20 blur-[110px] animate-aurora"
